...
study_direction_router = APIRouter(
    prefix="/study_direction",
    tags=["Study Direction"]
)
...
@study_direction_router.get("/get_by_id/{direction_id}", response_model=StudyDirectionResponse)
...
@study_direction_router.put("/update/{direction_id}", response_model=StudyDirectionResponse)
